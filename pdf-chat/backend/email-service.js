...
function getTransporter() {
  ...
  // Use service config for Gmail as recommended by nodemailer for reliability
  if (host === 'smtp.gmail.com') {
    return nodemailer.createTransport({
      ...
      connectionTimeout: 10000, // Fail-safe 10s timeout for hosting providers (e.g. Render)
